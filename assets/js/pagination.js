document.addEventListener('DOMContentLoaded', function() {
    ...
    const prevPagination = document.getElementById('prev-pagination');
    const nextPagination = document.getElementById('next-pagination');
    ...
    // Navigate to project page (for actual page navigation)
    function goToProjectPage(url) {
    ...
    prevPagination.addEventListener('click', function() {
        navigateToProject(getPrevIndex());
    });
    
    nextPagination.addEventListener('click', function() {
        navigateToProject(getNextIndex());
    });
    ...
    // Make functions available globally for use in individual project pages
    window.projectPagination = {
        navigateToProject,
        goToProjectPage,
        getPrevIndex,
        getNextIndex,
